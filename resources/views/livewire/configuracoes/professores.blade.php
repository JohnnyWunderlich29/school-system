<div>
    <div>
        <div class="flex">
            <livewire:titles.title-top-page title="Professores" />
            <div>
                <button type="button"
                    wire:click="$dispatch('openModal',{ component: 'configuracoes.modal.adicionar-professor', arguments:{formAction:'criar', title:'Cadastrar nova sala'}})"
                            ...
                            <a wire:click="atualizar()">
                                <button type="button"
                                    ...
                                    <svg fill="#ffffff" class="w-4 h-4" version="1.1" id="Capa_1"
                                        ...
                                        viewBox="0 0 348.882 348.882" xml:space="preserve" stroke="#ffffff">
