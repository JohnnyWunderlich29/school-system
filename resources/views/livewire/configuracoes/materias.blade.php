<div>
    <div>
        <div class="flex">
            <livewire:titles.title-top-page title="Matérias" />
            <div>
                <button type="button"
                    wire:click="$dispatch('openModal',{ component: 'configuracoes.modal.materias-base', arguments:{formAction:'criar', title:'Cadastrar nova matéria'}})"
        ...
        <div class="relative overflow-x-auto sm:rounded-lg">
            <div
                class="flex items-end justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 bg-white dark:bg-gray-900">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" id="sumir-botao-tabela">
                ...
                <tbody">
                    ...
                    <tr
                        ...
                        <td class="w-4 p-4">
                            <div class="flex items-center">
                                <input id="checkbox-table-search-2" type="checkbox"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="checkbox-table-search-2" class="sr-only" value="">checkbox</label>
                            </div>
                        </td>
                        <td scope="row"
                            class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="ps-3">
                                <div class="text-base font-semibold hover:cursor-pointer" wire:click="editar({{$materia->id}})">
                        ...
                        <td class="px-6 py-4">
                            <a wire:click="$dispatch('openModal', { component: 'configuracoes.modal.materias-base', arguments:{ id_materia: {{ $materia->id }}, formAction: 'atualizar', nome_materia: '{{ $materia->nome_materia }}', title: 'Atualizar - {{$materia->nome_materia}}'}})">
                                <button type="button"
