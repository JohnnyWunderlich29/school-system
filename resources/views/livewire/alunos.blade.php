<div>
    <div class="flex">
        <livewire:titles.title-top-page title="Alunos" />
        <livewire:button.modal-menu-top-page modal="modal-estudantes" />
                    ...
                    @foreach ($alunos as $aluno)
                        <tr
                            ...
                            <th scope="row"
                                ...
                                <div class="ps-3">
                                    <div class="text-base font-semibold hover:cursor-pointer"
                                        wire:click="redirecionar({{ $aluno->id }})">
                                        {{ $aluno->nome_completo }}</div>
                                    <div class="font-normal text-gray-500" x-mask="(99) 99999-9999">Contato
                                        prioritario: {{ $aluno->contato }}</div>
                                </div>
                            </th>
                            <td class="px-6 py-4">
                                {{ $aluno->alunos_salas ?  $aluno->alunos_salas->salas[0]->nome_sala : 'não existe'}}
                            </td>
