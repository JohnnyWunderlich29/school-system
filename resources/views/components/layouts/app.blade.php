...
<body>
    ...
    <div>
        ...
        <aside id="logo-sidebar"
            ...
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    @endif
                    @if (Route::has('escola_configuracao'))
                        <li class="md:hidden">
                            <a href="/escola/configuracao"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Escola configuração</span>
                            </a>
                        </li>
                    @endif
                    @if (Route::has('testes'))
                        <li>
                            <a href="/testes"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Testes</span>
                            </a>
                        </li>
                    @endif
        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200  rounded-lg shadow-md mt-14">
                <div class="flex flex-wrap grid overflow-x-auto">
                    {{ $slot }}
                </div>
            </div>
        </div>
